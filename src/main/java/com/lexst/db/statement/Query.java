...
public class Query extends SQLObject {
	...
	private int splitCondition(byte[] b, int offset, int len, boolean friend) {
		...
		case Type.TIME:
			column = new Time(); break;
		case Type.TIMESTAMP:
			column = new TimeStamp(); break;
		default:
